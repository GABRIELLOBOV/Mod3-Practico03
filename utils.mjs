...
export function leerSuperheroes (ruta) { 
    ...
    hero.nombreSociedad, hero.edad, hero.planetaOrigen, hero.debilidad, hero.poder, hero. habilidadEspecial, hero. aliado, hero.enemigo) 
); 
...
export function agregarSuperheroes(rutaOriginal, rutaNuevos) { 
    ...
    // try intenta ejecutar el codigo y continuar sin bloquearse ante un error
    try {
    ...
    // catch seria el codigo de error en caso de excepcion 
    catch (error) {
